...
- messages written by the program which is not executed by the interpreter
"""
...
# Python ma variable declare garne command chai xaina.
# python ma variable ko data type declare na gare declare garna sakxina and paxe type change garna sakxau
...
# ⭐️ lets print some data stored in the variables
