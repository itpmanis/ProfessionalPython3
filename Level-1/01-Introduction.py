...
print("Subtraction: ", 5-3)  # Output:  Subtraction:  2
print("Multiplication: ", 2*3)  # Output:  Multiplication:  6
print("Division: ", 6/3)  # Output:  Division:  2.0
print("Modulus: ", 5 % 3)  # Output:  Modulus:  2
print("Exponentiation: ", 2**3)  # Output:  Exponentiation:  8
print("Floor Division: ", 5//3)  # Output:  Floor Division:  1
